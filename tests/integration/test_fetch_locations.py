...
async def test_fetch_locations_from_google_sheet():
    sheet_url = "https://docs.google.com/spreadsheets/d/1jGa8Y6UmdU1YAY2GbtKSNt80GggSkaEU5CvWAB2InBE/pub?gid=0&single=true&output=csv"  # Replace with your actual Google Sheet URL
